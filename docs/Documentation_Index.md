...
Canonical v2 blueprint: [root HLD](../ARCHITECTURE.md) · [LLD](LLD.md) · [migration matrix](../MIGRATION_MATRIX.md) · [36-week roadmap](../ROADMAP.md). Current system references: [Architecture_Overview.md](Architecture_Overview.md) · [AegisAgent_Technical_Design.md](AegisAgent_Technical_Design.md) · [security-model.md](security-model.md) · [AegisAgent_Threat_Model.md](AegisAgent_Threat_Model.md) · [fail-closed-behavior.md](fail-closed-behavior.md) · [database-schema.md](database-schema.md) · [runtime-authorization-api.md](runtime-authorization-api.md) + [api-reference.md](api-reference.md) · [event-schema.md](event-schema.md) · [action-receipt-spec.md](action-receipt-spec.md) · [evidence-graph.md](evidence-graph.md) · [AegisAgent_Runtime_Data_Plane.md](AegisAgent_Runtime_Data_Plane.md) · prior target working documents: [AegisAgent_World_Class_HLD.md](AegisAgent_World_Class_HLD.md), [AegisAgent_World_Class_LLD.md](AegisAgent_World_Class_LLD.md) · decisions: [adr/index.md](adr/index.md).
