...
| Node sensor | Partial | `bins/aegis-node-sensor` (main, spool, shipper, command_receiver, **process_enforcer**), Dockerfile, Helm, compose | **real** process/fs/network/secret collectors that register PIDs | Phased PR plan §5 | unit (incl. host kill/pause) | beta | collectors + e2e |
