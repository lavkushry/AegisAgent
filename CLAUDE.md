...
**Python SDK — 179 tests, fully verified on `main`:**
...
**Rust gateway — 480 tests, verified on `main`:**
...
cargo test   --manifest-path gateway/Cargo.toml        # 480 tests
