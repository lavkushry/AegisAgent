...
class AegisClient:
    ...
    def __repr__(self) -> str:
        return (
            f"AegisClient(api_key={self.api_key!r}, agent_id={self.agent_id!r}, "
            f"environment={self.environment!r}, endpoint={self.endpoint!r})"
        )

    def __str__(self) -> str:
        return f"AegisClient(agent_id={self.agent_id}, environment={self.environment}, endpoint={self.endpoint})"
    ...
    def _request(self, method: str, path: str, **kwargs) -> requests.Response:
        ...
        # Safely extract response text and headers for logging (handling MagicMock in tests)
