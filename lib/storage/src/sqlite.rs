...
impl StorageBackend for SqlDbStorage {
    ...
    async fn count_decisions_grouped(
        ...
        db::count_decisions_grouped(&self.pool, tenant_id, field, filters, limit)
            .await
            .map_err(AegisError::Database)
    }
    ...
    async fn count_runtime_events(
        ...
        db::count_runtime_events(&self.pool, tenant_id, filters)
            .await
            .map_err(AegisError::Database)
    }
    ...
    async fn get_sensor(
        ...
        db::get_sensor(&self.pool, tenant_id, sensor_id)
            .await
            .map_err(AegisError::Database)
    }
    ...
    async fn list_sensors(
        ...
        db::list_sensors(&self.pool, tenant_id, limit, offset)
            .await
            .map_err(AegisError::Database)
    }
    ...
    async fn list_threat_hunt_findings(
        ...
        db::list_threat_hunt_findings(&self.pool, tenant_id, status, limit)
            .await
            .map_err(AegisError::Database)
    }
